use crate::codebook;
use crate::models::{
    CodebookConfig, DevicesPayload, SecureAccount, VaultEntries, VaultStatus, VaultxExportRequest,
    VaultxExportResult, VaultxImportRequest, VaultxPreviewRequest, VaultxPreviewResult,
};
use tauri::AppHandle;
...
#[tauri::command]
pub fn codebook_save_config(
    app: AppHandle,
    config: CodebookConfig,
) -> Result<CodebookConfig, String> {
    codebook::save_config(app, config)
}

#[tauri::command]
pub fn codebook_change_password(
    app: AppHandle,
    new_password: String,
) -> Result<VaultStatus, String> {
...
#[tauri::command]
pub fn codebook_import_vaultx(
    app: AppHandle,
    req: VaultxImportRequest,
) -> Result<VaultEntries, String> {
    codebook::import_vaultx(app, req)
}

#[tauri::command]
pub fn codebook_preview_vaultx(
    app: AppHandle,
