...
const enMessages = Object.fromEntries<string>([
  ...
  ['媒体批处理', 'Media Batch'],
  ['批量提取视频/图片信息，重命名与可视化分析，一站式处理', 'Batch extract video/image info, rename and visualize in one place'],
  ['并行提取 · 重命名 · 数据分析', 'Parallel extraction · Renaming · Data analytics'],
  ['实时导入', 'Live import'],
